...
Ricky Password yavuze ko iyi ndirimbo ifite igisobanuro gikomeye ku bihe by’urukundo yanyuzemo, akaba ari ho yakuye inspiration yo kuyandika no kuyikora.

Mu kiganiro twagiranye na we, yadutangarije ko yashakaga gukora indirimbo ifite amarangamutima kandi abantu benshi bashobora kwisanzuramo bitewe n’inkuru ikubiyemo.

Twamubajije niba ateganya gukora amashusho yayo, adusubiza ko bishoboka ariko ubu icyo ahugiyemo cyane ari EP iri gutegurwa.

“Budget ya clip ntabwo iba yoroshye ku muntu udafite label, so ndi kubitekerezaho,” — Ricky Password.
...
Ricky Password's fans are buzzing with excitement — not just to see the movie itself, but to watch Ricky Password in a whole new light, as a movie actor. This marks one of the most anticipated appearances of the year for the artist, widely known for his energetic stage presence and unique musical style.
...

{
    ...
    title: 'Ricky Password back in studio',
    date: '2025-09-30',
    excerpt: 'Ricky Password Back in the Studio with Hit Producer KOZEE',
    cover_url: 'https://rickypassword.com/gallery/studio_session_1.jpg',
    content: `
...

{
    ...
    content: `
Rwandan music artist Ricky Password has once again proven his versatility by stepping into the world of cinema.

In a yet-to-be-released Rwandan movie "IBYAHISHUWE", Ricky Password takes on one of the leading roles, starring alongside Kate Kayitabarwa, one of the country’s most celebrated actresses. The trailer has already sparked excitement, giving fans a glimpse of his performance on the big screen.
...

{
    ...
    content: `
It’s been a while since fans heard new music from Ricky Password, but the wait is nearly over.

The Rwandan artist has confirmed that he is working on a fresh release, marking his return after his last single, “Star”, which was shared only in audio format without a music video.
